...
test: $(TEST_OBJ) $(OBJ)
	...
	$(CXX) $(TEST_OBJ) obj/Rectangle.o obj/RectangleIntersection.o -Lthird_party/googletest/build/lib -lgtest -lgtest_main -lgmock -o test_infoTask.exe -DUNIT_TEST -mconsole
	@./test_infoTask.exe test.json
	del /Q test_infoTask.exe
